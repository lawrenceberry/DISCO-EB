...
Two implementations of the Rodas5P stiff Rosenbrock-W method are provided:
...
The ensemble driver, PID step control, and custom-vmap wrapper are kept here so
both implementations share one self-contained solver module.
"""
...
# --- Rodas5P numba kernel and solver -----------------------------------------
...
def rodas5Pnumba_solve(
    ...
    *,
    ...
    CUDA-device callbacks using the packed-row signatures consumed below.
    """
