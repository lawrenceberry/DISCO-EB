...
evolve_background(param=cosmo_params, num_thermo=1024)

print("STARTING COMPUTATION...")
start = time.time()
# with jax.profiler.trace("./profile_background_trace"):
result = evolve_background(param=cosmo_params, num_thermo=1024)
